...
object MappingStubs {
  ...
  val listOfSaMappings =
    List(SaMapping("ARN0001", "AgentCode1"), SaMapping("ARN0001", "AgentCode2"))

  val listOfVatMappings =
    List(VatMapping("ARN0001", "101747696"), VatMapping("ARN0001", "101747641"))
