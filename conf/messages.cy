...
error.utr.invalid.format=Nodwch Gyfeirnod Unigryw y Trethdalwr (UTR) dilys sydd ond yn cynnwys rhifau a bylchau, megis 12345 67890
...
#TestOnly
view.mappings.title=Dyma’ch Mapiadau
no.mappings.title=Nid oes Mapiadau
...
timeout-dialog.p1=Am resymau diogelwch, cewch eich allgofnodi ymhen
...
accessibility.statement.nonaccessible.heading=Cynnwys nad yw’n hygyrch
accessibility.statement.nonaccessible.p1=Nid yw’r cynnwys a restrir isod yn hygyrch oherwydd y rhesymau canlynol.

accessibility.statement.noncompliance.heading=Diffyg cydymffurfio â’r rheoliadau hygyrchedd
